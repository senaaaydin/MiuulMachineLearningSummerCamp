...
df.drop("age", axis=1).head() #sütun silineceği için axis=1
...
df.pivot_table("survived", "sex", "embarked") #pivot un ön tanımı ortalama dolayısıyla survived in ort alındı
...
df["new_age"] = pd.cut(df["age"], [0, 10, 18, 25, 40, 90]) #sayısalı kategorik değişkene değişiyor
